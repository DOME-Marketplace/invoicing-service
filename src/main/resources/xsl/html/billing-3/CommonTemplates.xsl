...
<xsl:stylesheet version="1.0"
    ...
    <xsl:variable name="moduleDocBT_en" select="document('billing-3/Headlines-BT_en.xml')" />
    <xsl:variable name="moduleDocBT" select="document(concat('billing-3/Headlines-BT_', $languageCode, '.xml'))" />
    <xsl:variable name="moduleDocUMZBT_en" select="document('billing-3/Headlines-UMZ-BT_en.xml')" />
    <xsl:variable name="moduleDocUMZBT" select="document(concat('billing-3/Headlines-UMZ-BT_', $languageCode, '.xml'))" />
    <xsl:variable name="invoiceBaseType" select="document(concat('billing-3/UBLInvoiceBaseType_',$languageCode, '.xml'))" />
    ...
    <xsl:variable name="invoiceBaseType_en" select="document('billing-3/UBLInvoiceBaseType_en.xml')" />
